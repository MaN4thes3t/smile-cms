...
/* @var $searchModel backend\modules\advice\models\AdviceSearch */

$this->title = Yii::t('backend','Советы');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="advice-translate-index">

    <h1><?= SmileHtml::encode($this->title) ?></h1>

    <p>
        <?= SmileHtml::a(Yii::t('backend','Создать новый совет'), ['create'], ['class' => 'btn btn-success']) ?>
