...
$this->title = Yii::t('backend','Источники');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="source-translate-index">

    <h1><?= SmileHtml::encode($this->title) ?></h1>

    <p>
        <?= SmileHtml::a(Yii::t('backend','Создать новый источник'), ['create'], ['class' => 'btn btn-success']) ?>
            ...
            [
                ...
                'value'=>function($data) {
                    ...
                    foreach(Yii::$app->params['languages'] as $key=>$lang){
                        $output .= $key.': '.$data->translate[$key]->name.'<br/>';
                    }
