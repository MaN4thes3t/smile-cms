...
if($leader){
    ...
    ?>
    <div class="birthday clear">
        <h2 class="blockHeader">          <a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('/leaders')?>"
                ...
                <figcaption>
                    ...
                    <p><a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl('/leaders/'.$leader['translit'])?>"
                          title="<?php echo $name?>">
                            ...
                            $date = getdate($leader['birthday']);
                            ?>
                            <time><?php echo $date['mday'].' '.$month[$date['mon']].' '.date('H:i', $leader['birthday'])?></time>
                        </a></p>
                </figcaption>
            </figure>
        </div>
